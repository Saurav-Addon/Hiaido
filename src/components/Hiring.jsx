  ...
  return (
    <>
      ...
      <div className="pt-[4.75rem] lg:pt-[5.25rem]  ">
        <form onSubmit={handleSubmit} className="max-w-md mt-10 mx-auto px-5 ">
          ...
          <div className="grid items-center md:grid-cols-2 md:gap-6  ">
            <div className="relative z-0 w-32 mb-5 group ">
              <select
                required={true}
                className="py-2.5 px-0 w-52 text-l text-white-500 border-0  bg-transparent border-b-2 border-gray-200 dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 "
                onChange={handleInputChange}
